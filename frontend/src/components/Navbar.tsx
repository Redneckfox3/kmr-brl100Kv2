...
import { Snowflake, ClipboardList, BarChart3, Settings as SettingsIcon, Menu, X, Cloud, Database, Package } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/cilinders', label: 'Cilinderbeheer', icon: Package },
